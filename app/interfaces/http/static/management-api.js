(function (global) {
  ...
  global.NAGENT.api = {
    ...
    task: {
      ...
      link: (body) => fetchJson('/chat/tasks/links', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(body) }),
      specify: (id) => fetchJson('/chat/tasks/' + encodeURIComponent(id) + '/specify', { method: 'POST' }),
      decompose: (id) => fetchJson('/chat/tasks/' + encodeURIComponent(id) + '/decompose', { method: 'POST' }),
      swarm: (body) => fetchJson('/chat/tasks/swarm', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(body) }),
